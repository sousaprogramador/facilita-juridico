...
import { currencyMaskOptions } from '~/data/currency-mask-option'
import createNumberMask from 'text-mask-addons/dist/createNumberMask'

const currencyOptions = createNumberMask(currencyMaskOptions)
...
export const MoneyInput = forwardRef<HTMLInputElement, Omit<InputProps, 'mask'>>((props, ref) => {
  return (
